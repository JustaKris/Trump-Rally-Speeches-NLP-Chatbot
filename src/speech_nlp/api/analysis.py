...
from speech_nlp.api.dependencies import (
    get_nlp_service,
    get_sentiment_analyzer_dep,
    get_topic_service,
)
from speech_nlp.schemas import (
...
from speech_nlp.services import EnhancedSentimentAnalyzer, NLPService
from speech_nlp.utils import clean_text
...
async def analyze_sentiment(
    ...
    try:
        logger.info("Sentiment analysis request (text_length=%d)", len(input.text))
...
async def analyze_topics(
    ...
    try:
        logger.info(
            "Topic extraction request (text_length=%d, top_n=%d, clusters=%s)",
            len(input.text),
            top_n,
            num_clusters,
        )
