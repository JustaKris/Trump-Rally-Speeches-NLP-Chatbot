...
from speech_nlp.services.llm.gemini import GeminiLLM

# Import optional providers (may not be installed)
try:
    from speech_nlp.services.llm.openai import OpenAILLM
...
try:
    from speech_nlp.services.llm.anthropic import AnthropicLLM
